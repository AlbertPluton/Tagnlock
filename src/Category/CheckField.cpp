...
CheckField::CheckField( string fieldLabel, bool fieldRequired, bool fieldReset ) : Field( fieldLabel, fieldRequired, fieldReset)
{
...
CheckField::CheckField( vector<string> * description )
{
	string str;

	// Start the loop from the second item in the description. This because the type is already known.
